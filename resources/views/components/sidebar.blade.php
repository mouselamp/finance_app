        ...
        <nav class="px-3 py-4">
            ...
            <div class="mb-6">
                ...
                <a href="{{ route('receipts.index') }}"
                   class="flex items-center px-3 py-2 mb-1 text-sm font-medium rounded-lg {{ request()->routeIs('receipts*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6M9 8h6m5 8V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2z"></path>
                    </svg>
                    Analisis Struk
                </a>

                <a href="{{ route('groups.index') }}"
                   class="flex items-center px-3 py-2 mb-1 text-sm font-medium rounded-lg {{ request()->routeIs('groups*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
